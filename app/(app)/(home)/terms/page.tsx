  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20 text-neutral-800">
      ...
      <section className="mt-10 space-y-6 text-sm leading-relaxed">
        <p>
          Welcome to <strong>BJJ Mat</strong>. By accessing or using our
          platform, you agree to be bound by these Terms of Service.
        </p>

        <h2 className="text-lg font-semibold">1. What BJJ Mat does</h2>
        <p>
          BJJ Mat is a marketplace that helps Brazilian Jiu-Jitsu gyms manage
        ...
        <p>
          You may use BJJ Mat without creating an account for drop-in bookings.
          Creating an account allows you to manage bookings and personal
          details.
        </p>
        ...
        <p>
          ...
          Stripe). BJJ Mat does not store your card or bank details.
        </p>

        <p>
          Drop-in prices, refunds, and class availability are determined by each
          gym.
        </p>

        <h2 className="text-lg font-semibold">4. Waivers & training risk</h2>
        <p>
          Brazilian Jiu-Jitsu is a physical sport with inherent risks. By
          booking or attending a class, you acknowledge that you participate at
          your own risk.
        </p>

        <p>Any waivers you sign are between you and the gym, not BJJ Mat.</p>
        ...
        <p>
          To the maximum extent permitted by law, BJJ Mat is not liable for
        ...
        <p>
          ...
          <a href="mailto:contact@bjjdesk.io" className="font-medium underline">
            contact@bjjdesk.io
          </a>
          .
        </p>
